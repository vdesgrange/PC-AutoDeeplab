...
class Cell(nn.Module):
    ...
    def __init__(self, steps, block_multiplier, prev_prev_fmultiplier,
        ...
        self.C_prev = int(prev_filter_multiplier * block_multiplier)
    ...
    def forward(self, prev_prev_input, prev_input):
        ...
        for i in range(self._steps):
            h = states[self.cell_arch[i][0]]
            new_state = self._ops[i](h)
        ...
        #             # Handle case where we are at the first level of the architecture
        ...
        #     states.append(s)
        #
        # states_to_concat = states[-self.block_multiplier:]  # Get the last X "block_multiplier" elements of the list
        # concat_feature = torch.cat(states_to_concat, dim=1)
...
class newModel(nn.Module):
    def __init__(self, network_arch, cell_arch, num_classes, num_layers, filter_multiplier=20, lock_multiplier=5, step=5, cell=Cell,
        ...
        # self.use_ABN = args.use_ABN # Buggy with used GPU
